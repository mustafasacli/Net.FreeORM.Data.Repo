...
{
    class ConnectionOracleNet : IConnection
    {
        OracleConnection Conn = null;
        OracleTransaction Trans = null;

        internal ConnectionOracleNet()
        {
            Conn = new OracleConnection();
        }

        internal ConnectionOracleNet(string connectionString)
        {
        ...
        {
            get { return ConnectionTypes.OracleNet; }
        }
