...
{
    class ConnectionVistaDB : IConnection
    {
        VistaDBConnection Conn = null;
        VistaDBTransaction Trans = null;

        internal ConnectionVistaDB()
        {
            Conn = new VistaDBConnection();
        }

        internal ConnectionVistaDB(string connectionString)
        {
        ...
        {
            get { return new VistaDBConnectionStringBuilder(); }
        }

        public ConnectionTypes ConnectionType
        {
            get { return ConnectionTypes.VistaDB; }
        }
        ...
        public DbDataAdapter CreateAdapter()
        {
            try
            {
                ...
                dtAdapter = new VistaDBDataAdapter();
                return dtAdapter;
            }
            catch (Exception)
            {
