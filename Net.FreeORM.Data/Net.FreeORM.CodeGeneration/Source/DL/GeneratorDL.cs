...
namespace Net.FreeORM.CodeGeneration.Source.DL
{
    internal class GeneratorDL
    {
        ...
        public DataTable GetOracleTablesM(string connectionString)
        {
            ...
            try
            {
                using (IConnection freeConn = ConnectionFactory.CreateConnection(ConnectionTypes.OracleManaged, connectionString))
                {
                    using (DbCommand dbCmd = freeConn.CreateCommand())
                    {
        ...
        public DataTable GetOracleTablesN(string connectionString)
        {
            ...
            try
            {
                using (IConnection freeConn = ConnectionFactory.CreateConnection(ConnectionTypes.OracleNet, connectionString))
                {
                    using (DbCommand dbCmd = freeConn.CreateCommand())
                    {
        ...
        public DataTable GetVistaDBTables(string connectionString)
        {
            ...
            try
            {
                using (IConnection freeConn = ConnectionFactory.CreateConnection(ConnectionTypes.VistaDB, connectionString))
                {
                    using (DbCommand dbCmd = freeConn.CreateCommand())
                    {
        ...
        public DataTable GetInformixTable(string connectionString)
        {
            ...
            try
            {
                ...
                using (IConnection freeConn = ConnectionFactory.CreateConnection(ConnectionTypes.Informix, connectionString))
                {
                    using (DbCommand dbCmd = freeConn.CreateCommand())
                    {
        ...
        public DataTable GetFireBirdTables(string connectionString)
        {
            ...
            try
            {
                ...
                using (IConnection freeConn = ConnectionFactory.CreateConnection(ConnectionTypes.FireBird, connectionString))
                {
                    using (DbCommand dbCmd = freeConn.CreateCommand())
                    {
        ...
        public DataTable GetSybaseTables(string connectionString)
        {
            ...
            try
            {
                using (IConnection freeConn = ConnectionFactory.CreateConnection(ConnectionTypes.Sybase, connectionString))
                {
                    using (DbCommand dbCmd = freeConn.CreateCommand())
                    {
